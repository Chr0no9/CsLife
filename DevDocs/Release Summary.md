...
There are no known problems with the game or bugs. There were some decisions that were made later on during the development process in order to simplify the game and not make it too complex for us to develop later on.
